...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-sumcoin/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-sumcoin -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-sumcoin -o bitcore-lib-sumcoin.js';
    }
